...
- Build with Gradle v9.5.0
- Upgraded Pandoc to v3.9.0.2
- Upgraded reveal.js to v6.0.1
- Upgraded dependencies
- Upgraded GitHub Actions
- [all changes since v0.6.2]
...
- Build with Gradle v9.3.1
- Upgraded Pandoc to v3.9
- Upgraded dependencies
- Upgraded GitHub Actions
...
- Support for Java versions older than 17
- Support for Gradle versions older than v7.2

### Changed

- Plugin logic
- Build with Gradle v9.2.0
- Upgraded Pandoc to v3.8.2.1
- Upgraded dependencies
- Upgraded GitHub Actions
- [all changes since v0.5.10]
...
[all changes since v0.6.2]: https://github.com/m2ci-msp/gradle-pandoc-reveal-plugin/compare/v0.6.2...HEAD
[v0.6.2]: https://github.com/m2ci-msp/gradle-pandoc-reveal-plugin/releases/tag/v0.6.2
[all changes since v0.6.1]: https://github.com/m2ci-msp/gradle-pandoc-reveal-plugin/compare/v0.6.1...v0.6.2
[v0.6.1]: https://github.com/m2ci-msp/gradle-pandoc-reveal-plugin/releases/tag/v0.6.1
[all changes since v0.6.0]: https://github.com/m2ci-msp/gradle-pandoc-reveal-plugin/compare/v0.6.0...v0.6.1
[v0.6.0]: https://github.com/m2ci-msp/gradle-pandoc-reveal-plugin/releases/tag/v0.6.0
[all changes since v0.5.10]: https://github.com/m2ci-msp/gradle-pandoc-reveal-plugin/compare/v0.5.10...v0.6.0
[v0.5.10]: https://github.com/m2ci-msp/gradle-pandoc-reveal-plugin/releases/tag/v0.5.10
[all changes since v0.5.9]: https://github.com/m2ci-msp/gradle-pandoc-reveal-plugin/compare/v0.5.9...v0.5.10
